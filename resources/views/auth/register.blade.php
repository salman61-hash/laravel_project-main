...
<!-- Mirrored from techzaa.in/velonic/layouts/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Nov 2024 06:17:47 GMT -->
...
<body class="authentication-bg">
    ...
    <div class="account-pages pt-2 pt-sm-5 pb-4 pb-sm-5 position-relative">
                                    ...
                                    <div class="p-4 my-auto">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input id="fullname" class="block mt-1 w-full" type="text"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input id="emailaddress" class="block mt-1 w-full" type="email"
        ...
        {{-- </div> --}}
                                            ...
                                            <div class="mb-3">
                                                <label for="confirm_password" class="form-label">Confirm confirm_</label>
